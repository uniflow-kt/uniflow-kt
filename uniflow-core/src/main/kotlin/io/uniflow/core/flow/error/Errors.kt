...
class NetworkException(message: String? = null, error: Throwable? = null) : ThrowableKt(message, error?.toThrowableKt())
class DatabaseException(message: String? = null, error: Throwable? = null) : ThrowableKt(message, error?.toThrowableKt())
